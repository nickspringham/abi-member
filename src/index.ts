 ...
 */
async function scrapeAbiMembers(): Promise<void> {
 ...
 */
function generateMarkdown(members: AbiMember[]): string {
 ...
 */
async function writeJsonFile(members: AbiMember[], filePath: string): Promise<void> {
